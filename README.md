...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/600a454e4a8f8c0015894942
...
To start editing your site, you can use the Sanity interface at https://miguelgaitansite-a454e.sanity.studio/.
...
Generated at `2021-01-22T03:38:41.372Z` by Stackbit version `0.3.43`.